...
class BasicForm extends React.Component {
    ...
    fakeSubmitForm = async (payload) => {
        this.changeLoading();
        let response = await request('/fakeSubmitForm', payload)
        return response
    }
    ...
    handleSubmit = (e) => {
        ...
        form.validateFieldsAndScroll((err, values) => {
            if (!err) {
                const response = this.fakeSubmitForm(values)
                if (response) message.success('提交成功');
                this.changeLoading();
                this.handleReset();
            }
        });
                    ...
                    <Form onSubmit={this.handleSubmit} hideRequiredMark>
                        ...
                        <FormItem
                            ...
                            label={(
                                <span>
                                    客户
                                    <em className="basic-form-optional">
                                        （选填）
                        ...
                        <FormItem
                            ...
                            label={(
                                <span>
                                      邀评人
                                      <em className="basic-form-optional">（选填）</em>
                                  </span>
                            )}>
                            {
